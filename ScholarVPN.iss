...
; 使用方法(三步，或者直接运行 scripts\package.bat 一键完成):
...
; 目标机器无需安装任何运行环境，Qt/OpenSSL/Wintun 以及插件全部随包安装。
; ============================================================
...
[Setup]
; AppId 唯一标识本应用，不要和其它安装程序共用
AppId={{CECB2BA2-256E-4200-802E-FA3D2AEBB0F7}
AppName={#MyAppName}
AppVersion={#MyAppVersion}
AppPublisher={#MyAppPublisher}

; 程序需要创建 TUN 网卡/修改路由/修改DNS/写注册表，必须管理员权限
...
[Languages]
; 简体中文 Inno Setup，Default.isl 就是简体中文
...
[UninstallDelete]
; 卸载默认保留 %APPDATA%\ScholarVPN(用户配置与身份密钥)
; 需要彻底清除可以取消下面一行注释
